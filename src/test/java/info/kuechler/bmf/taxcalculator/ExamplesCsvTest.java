...
public class ExamplesCsvTest {
	...
	private static final WriterTaxClassConfigurer CONF_GENERAL_PKV_13 = (writer, taxClass) -> {
		// additional med insurance [percent]
		writer.set("KVZ", new BigDecimal("1.30"));
    ...
    public static Stream<Arguments> dataProvider() {
        return Stream.of( //
                ...
                arguments("/info/kuechler/bmf/taxcalculator/2021/general.csv", 0, 2021, CONF_GENERAL_PKV_13),
                arguments("/info/kuechler/bmf/taxcalculator/2021/special.csv", 0, 2021, CONF_SPECIAL_PKV),
                ...
                arguments("/info/kuechler/bmf/taxcalculator/2023/general.csv", -1, 2023, CONF_GENERAL_PKV_16),
                arguments("/info/kuechler/bmf/taxcalculator/2023/special.csv", -1, 2023, CONF_SPECIAL_PKV), 
                arguments("/info/kuechler/bmf/taxcalculator/2023/general-januar.csv", 0, 2023, CONF_GENERAL_PKV_16),
                arguments("/info/kuechler/bmf/taxcalculator/2023/special-januar.csv", 0, 2023, CONF_SPECIAL_PKV)   //
                //
        );
    }
